// Fuld liste kan altid findes her https://danmarksadresser.dk/adressedata/kodelister/kommunekodeliste
// Eller her https://api.dataforsyningen.dk/kommuner?udenforkommuneinddeling=false
// Det er reelt kommuner og ikke byer...
const cityData = [
    "København",
    "Frederiksberg",
    "Ballerup",
...
// Lookup kommune for specific postal number
// https://api.dataforsyningen.dk/postnumre?nr=2870
const postalData = {
    "8000": "Aarhus C",
    "5000": "Odense C",
    "9000": "Aalborg C",
    ...
    "2400": "København NV (Nordvest)",
    "2450": "København SV (Sydhavnen)",
    "2500": "Valby",
    "2600": "Glostrup",
    "2605": "Brøndby",
    "2610": "Rødovre",
...
// Quick-select area groups for the Smart Area Picker
// The backend is responsible for expanding these IDs into full postal code arrays
export const areaGroups = [
    { id: '10002500', label: '1000-2999 Hele København', icon: 'fa-solid fa-map' },
    { id: '10001499', label: '1000-1499 København K (Indre by)', icon: 'fa-solid fa-landmark' },
    { id: '15001799', label: '1500-1799 Vesterbro', icon: 'fa-solid fa-city' },
    { id: '18002000', label: '1800-2000 Frederiksberg', icon: 'fa-solid fa-tree-city' }
];

export const searchAreaGroups = [
    { id: '10002500', label: '1000-2999 Hele København', icon: 'fa-solid fa-map' },
    { id: '10001499', label: '1000-1499 København K (Indre by)', icon: 'fa-solid fa-landmark' },
    { id: '15001799', label: '1500-1799 Vesterbro', icon: 'fa-solid fa-city' },
    { id: '18002000', label: '1800-2000 Frederiksberg', icon: 'fa-solid fa-tree-city' },
    // TODO These are bugged for some reason? østerbro etc can still be searched
    // { id: '2100', label: 'København Ø (Østerbro)', icon: 'fa-solid fa-sailboat' },
    // { id: '2200', label: 'København N (Nørrebro)', icon: 'fa-solid fa-people-group' },
    // { id: '2300', label: 'København S (Amager)', icon: 'fa-solid fa-water' },
    // { id: '2400', label: 'København NV (Nordvest)', icon: 'fa-solid fa-compass' },
    // { id: '2450', label: 'København SV (Sydhavnen)', icon: 'fa-solid fa-anchor' },
    // { id: '2500', label: 'Valby', icon: 'fa-solid fa-house' }
];

export const areaAutocompleteOptions = (() => {
    const options = [];
    ...
    areaGroups.forEach(group => {
        ...
        options.push({
            ...
            icon: group.icon,
            searchText: `${group.label} ${id}`.toLowerCase()
        });
    });

    Object.entries(postalData).forEach(([postal, city]) => {
        const id = String(postal).trim();
        if (!id || seenIds.has(id)) return;
        seenIds.add(id);
        options.push({
            id,
            ...
            searchText: `${id} ${city}`.toLowerCase()
        });
    });
