...
<section class="border-top pt-5 pb-4 bg-light text-center" style="font-family: 'Lato', sans-serif;" aria-label="Find værelse i Danmark">
  <div class="container" style="max-width: 1500px;">
    <h6 class="fw-bold mb-3 text-dark">Find værelse i Danmark</h6>
    <ul class="list-unstyled d-flex flex-wrap justify-content-center gap-3 gap-md-4 mb-0">
